...
class TripPackagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create trip_package' do
    assert_difference('TripPackage.count') do
      post trip_packages_url,
           params: { trip_package: { country: @trip_package.country, description: @trip_package.description,
                                     name: @trip_package.name, price: @trip_package.price } }
    end
  ...
  test 'should update trip_package' do
    patch trip_package_url(@trip_package),
          params: { trip_package: { country: @trip_package.country, description: @trip_package.description,
                                    name: @trip_package.name, price: @trip_package.price } }
